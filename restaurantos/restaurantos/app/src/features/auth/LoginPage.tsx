    ...
    <div data-theme="dark" className="min-h-screen bg-ink text-paper flex flex-col items-center justify-center px-6 text-center">
      ...
      {status === 'unauthorized' ? (
        <>
          ...
          <p className="text-sm text-paper/50 mb-6 max-w-xs">Ask a manager to add you in Staff, then sign in again.</p>
        ...
        <>
          ...
          <p className="text-sm text-paper/50 mb-8">Sign in with the Google account your manager set up for you.</p>
          <button
            onClick={signInWithGoogle}
            className="flex items-center gap-3 rounded-2xl bg-white text-ink px-6 py-3.5 font-semibold hover:bg-white/90 active:scale-[0.98] transition-all"
          >
            <GoogleIcon />
            Sign in with Google
          </button>
